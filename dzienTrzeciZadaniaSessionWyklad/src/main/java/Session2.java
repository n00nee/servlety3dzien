...
public class Session2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.getWriter()
                .println("<html><body><form action=\"/session2\" method=\"get\">" +
                        "<input name=\"ocena\"><br><button type=\"submit\">wyslij</button>" +
                        "</form></body></html>");
        resp.getWriter().println("_______________________________________________");
        ...
        if(session.isNew()) {
            ...
            resp.getWriter().println("Srednia = " + (double) sumaOcen/oceny.size());
        }
